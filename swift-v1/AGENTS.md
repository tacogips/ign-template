...
This is `@ign-var:PROJECT_NAME={current_dir}@`, a Swift Package Manager project with mise-managed tools and tasks, Homebrew formula packaging, and optional signed Homebrew Cask packaging.
