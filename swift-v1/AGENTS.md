...
This is `@ign-var:PROJECT_NAME={current_dir}@`, a Swift Package Manager project with a Nix development shell, go-task automation, Homebrew formula packaging, and optional signed Homebrew Cask packaging.
